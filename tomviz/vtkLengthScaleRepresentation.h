...
public:
   ...
   */
  vtkTypeMacro(vtkLengthScaleRepresentation,vtkDistanceRepresentation2D)
...
private:
  vtkLengthScaleRepresentation(const vtkLengthScaleRepresentation&) VTK_DELETE_FUNCTION;
