...
// This takes as input an image and a slice number.  If the input image has
// dimensions
// [x, y, z] the slice number must be in the interval [0,y-1].  The output is
// stored in
// the sinogram pointer, which should be a pointer to an array with dimensions
// [y, z, 1].
